/**
 * Static fallback data from data.js — used when backend API is unavailable.
 * This ensures the site always shows content even without MongoDB running.
 */
...
export const fallbackDepartments = [
    { _id: 'd1', name: 'Computer Science', description: 'Computer Science & Engineering', icon: 'fa-laptop-code', color: 'from-blue-500 to-blue-600', materialCount: 6 },
    { _id: 'd2', name: 'CSIT', description: 'Computer Science & Information Technology', icon: 'fa-network-wired', color: 'from-cyan-500 to-teal-500', materialCount: 3 },
    { _id: 'd3', name: 'AI & ML', description: 'Artificial Intelligence & Machine Learning', icon: 'fa-brain', color: 'from-rose-500 to-pink-500', materialCount: 5 },
    { _id: 'd4', name: 'Data Analytics', description: 'Data Analytics & Data Science', icon: 'fa-chart-pie', color: 'from-emerald-500 to-green-500', materialCount: 1 },
    { _id: 'd5', name: 'IoT', description: 'Internet of Things', icon: 'fa-microchip', color: 'from-amber-500 to-orange-500', materialCount: 3 },
];
